 ...
 */
public class UserParamAdapter extends RecyclerView.Adapter<UserParamAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(View v) {
            ...
            paramValue = (TextView) v.findViewById(R.id.paramValue);
        }

    }

    // Инициализация
    public UserParamAdapter(String[] myDataset) {
        mDataset = myDataset;
    }

    // Создание нового холдера
    @Override
    public UserParamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_user_param, parent, false);
